...
export const AboutBody = () => {
  return (
    <div>
      <ul
        className="relative space-y-[40px] border-b-[0.5px] border-[#13A9FD] py-[80px] ml-[28px] list-outside marker:absolute marker:top-[10px] z-10 text-[24px] font-extralight list-disc leading-[34px] [&_p]::before"
