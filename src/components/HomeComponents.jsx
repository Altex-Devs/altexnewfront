  ...
  return (
    <>
      ...
      <div className="pt-[160px] relative mb-[240px]">
        <div className="absolute left-[-16px] w-screen h-[800px] top-[-30px] right-[-90px] bg-gradient-radial-bottom from-[rgba(0,108,255,0.26)] to-[rgba(19,169,253,0)] pointer-events-none touch-none"></div>
