      ...
      <div className="my-10">
        {isSubmitedPhoneNumber ?
          <>
            ...
            <button type="button" className="button mt-1 w-full" onClick={login}>
              {sending && <>
          ...
          :
          <>
            <input type="text" className="input" id="phonenumber" placeholder="+97687654321" defaultValue={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} onKeyDown={handleKeyDownOnPhoneNumber} />
