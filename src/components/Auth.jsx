      ...
      <div className="col-span-2 bg-[rgba(0,108,255,0.26)]">
        {isSubmitedPhoneNumber ?
          <>
              ...
              <div className='p-4 m-20 h-[500px] bg-[#000] flex items-center rounded-3xl relative'>
              <div>
              <div>
            <div className='relative w-[290px] h-[350px] text-[#000] rounded  bg-[#fff]'>
                    ...
                    <button type="button" className="button mt-1 w-full bg-[#000] text-[#fff] w-full h-max" onClick={login}>
                      {sending && <>
