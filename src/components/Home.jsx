  ...
  return (
    <>
      ...
      <div className="md:relative mb-[80px] md:mb-[28px]">
        <div style={{backgroundImage: 'url("/images/hero-pic.svg")'}} className="absolute w-screen md:w-[1151px] h-[620px] top-0 left-0 md:left-auto md:right-[-450px] lg:right-[-300px] bg-[length:600px] md:bg-auto bg-center bg-no-repeat pointer-events-none"></div>
      ...
      <div className="pt-[160px] relative mb-[240px]">
        <div className="absolute w-[800px] h-[800px] top-[-30px] right-[-90px] bg-gradient-radial-bottom from-[rgba(0,108,255,0.26)] to-[rgba(19,169,253,0)] pointer-events-none touch-none"></div>
