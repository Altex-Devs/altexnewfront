    ...
    <>
      <div className="container mx-auto bg-[#101C47] max-w-[600px] px-[40px] py-[24px] mb-[239px] mt-[80px]">
        ...
        <div className="flex justify-end">
          <div className="inline-block rounded-[4px] font-bold text-[14px] w-[100px] h-[48px] mt-[40px] grid justify-center content-center bg-gradient-to-b from-[#13A9FD] to-[#006CFF] mb-[32px]">Илгээх</div>
        </div>
      </div>
    </>
  );
