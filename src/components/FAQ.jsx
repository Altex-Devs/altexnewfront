      ...
      <div className="bg-[#F5F5F5] relative w-screen -left-[calc(50vw-50%)] mt-[40px] pt-[80px] pb-[240px]">
        <div className="container mx-auto pt-[48px] max-w-[1200px]">
          ...
          <Item title="1. Хэрхэн бүртгэлээ баталгаажуулах вэ?">
              <ul className="list-disc leading-6 px-14 text-[0.9rem] font-montserrat">
          ...
          <Item title="2. Хэрхэн бүртгэлээ устгах вэ?">
            <ul className="list-disc leading-2 px-14 text-[0.9rem] font-montserrat">
          ...
          <Item title="7. Хэрхэн хаягийн баталгаажуулалт хийх вэ?">
            <div className="text-[0.9rem] font-montserrat">Иргэний үнэмлэхийн арын хэсгийн зургийг тод гаргацтай авч илгээснээр хаягийг баталгаажуулах боломжтой.</div>
          </Item>
          ...
          {show === "button2" && (
            ...
            <Item title="1. Хэрхэн фиат орлого хийх вэ?">
                <ul className="list-disc leading-6 px-14 text-[0.9rem] font-montserrat overflow-y-auto">
                  <li><span className="font-bold">www.altex.mn</span> хуудсанд өөрийн үүсгэсэн <span className="font-bold">бүртгэлээрээ нэвтэрч орно</span>.</li>
            ...
            <Item title="4. Криптовалютын сүлжээний шимтгэл хэд вэ?">
              <ul className="list-disc leading-2 text-[0.9rem] font-montserrat">
            ...
            <Item title="9. Фиат орлогын шимтгэлтэй юу?">
              <div className="text-[0.9rem] font-montserrat">
                 <div>Байхгүй.</div>
    ...
    <>
      <div className={`${expanded ? "max-h-[800px]" : "max-h-[67px]"} rounded-[8px] bg-[#FFFFFF] text-[#35363B] p-[24px] overflow-hidden transition-[max-height] duration-500 mb-[24px] drop-shadow-[6px_6px_18px_rgba(0,108,255,0.04)]`} onClick={() => setExpanded(!expanded)}>
        <div className="flex justify-between items-center font-bold mb-[14px] cursor-pointer">
          ...
          <svg className={`transition-transform delay-100 duration-700 transform ${expanded ? 'rotate-180' : ''}`} width="17" height="9" viewBox="0 0 17 9" fill="none" xmlns="http://www.w3.org/2000/svg">
