      ...
      <div className="bg-[#F5F5F5] relative w-screen -left-[calc(50vw-50%)] mt-[40px] pt-[80px] pb-[240px]">
        <div className="container mx-auto pt-[48px] max-w-[1200px]">
          ...
          <Item title="2. Хэрхэн бүртгэлээ устгах вэ?">
            <ul className="list-disc leading-2 px-14 text-[0.9rem] font-sans">
          ...
          <Item title="6. 2FA хамгаалалтаа хэрхэн салгах вэ?">
              ...
              <div className="py-10">Санамж: 2FA холболтоо шинээр дахин хийгээгүй тохиолдолд крипто арилжаа, орлого зарлага хийх боломжгүй гэдгийг анхаарна уу.</div>
          </Item>

          <Item title="7. Хэрхэн хаягийн баталгаажуулалт хийх вэ?">
            <div className="text-[0.9rem] font-sans">Иргэний үнэмлэхийн арын хэсгийн зургийг тод гаргацтай авч илгээснээр хаягийг баталгаажуулах боломжтой.</div>
          </Item>
          ...
          <Item title="8. Иргэний үнэмлэхгүй бол хэрхэн хаягийн баталгаажуулалт хийх вэ?">
              ...
              <div className="py-10">Санамж: Баримт бичиг нь Монгол эсвэл Англи хэл дээр биш бол албан ёсны баталгаат орчуулгаар орчуулан баталгаа гаргасан байхыг анхаарна уу.</div>
          ...
          <Item title="9. Хэрхэн Итгэмжит харилцагч болох вэ?">
              <ul className="list-disc leading-2 px-14 text-[0.9rem] font-sans">
                ...
                <li>Баталгаажсан харилцагч нь өөрийн хэрэгцээ шаардлагаас хамааран өдөрт хийгдэх зарлагын хэмжээг нэмэгдүүлэн Итгэмжит харилцагч болох хүсэлт гаргасан тохиолдолд Итгэмжит харилцагчийн зарлагын дээд хэмжээний 1%-тай тэнцэхүйц шимтгэлийг 1 удаа төлнө.</li>
          ...
          <Item title="10. Компанийн хаяг нээхэд ямар бичиг баримтууд шаардлагатай вэ?">
              <ul className="list-disc leading-2 px-14 text-[0.9rem] font-sans">
                ...
                <li>Баталгаажсан харилцагч нь өөрийн хэрэгцээ шаардлагаас хамааран өдөрт хийгдэх зарлагын хэмжээг нэмэгдүүлэн Түнш харилцагч болох хүсэлт гаргасан тохиолдолд Түнш харилцагчийн зарлагын дээд хэмжээний 1%-тай тэнцэхүйц шимтгэлийг 1 удаа төлнө.</li>
                <li>Харилцагчийн бүртгэл хариуцсан ажилтан болон Эрсдэл хариуцсан ажилтан нь харилцагчийн хүсэлтийг ажлын 1 хоногт багтаан шийдвэрлэж энэ тухай харилцагчид имэйл эсхүл утсаар хариу мэдэгдэнэ. </li>
              </ul>
          </Item>
          ...
          <Item title="11. Хувь хүний бүртгэл баталгаажуулахад ямар бичиг баримтууд шаардлагатай вэ?">
              <ul className="list-disc leading-2 list-inside px-14 text-[0.9rem] font-sans">
          ...
          {show === "button2" && (
            ...
            <Item title="1. Хэрхэн фиат орлого хийх вэ?">
                <ul className="list-disc leading-6 px-14 text-[0.9rem] font-sans overflow-y-auto">
                  <li><span className="font-bold">www.altex.mn</span> хуудсанд өөрийн үүсгэсэн <span className="font-bold">бүртгэлээрээ нэвтэрч орно</span>.</li>
                ...
                <div className="text-[0.9rem] font-sans mt-10">
            ...
            <Item title="4. Криптовалютын сүлжээний шимтгэл хэд вэ?">
              <ul className="list-disc leading-2 text-[0.9rem] font-sans">
            ...
            <Item title="7. Гуравдагч этгээдээр дамжуулан гүйлгээ хийх боломжтой юу? Хамтран эзэмшигчтэй данснаас Орлого/Зарлага хийх боломжтой юу?">
                <ul className="list-disc leading-2 px-14 text-[0.9rem] font-sans">
            ...
            <Item title="9. Фиат орлогын шимтгэлтэй юу?">
              <div className="text-[0.9rem] font-sans">
                 <div>Байхгүй.</div>
...
const Item = ({title, children}) => {
  ...
  return (
    <>
      <div className={`${expanded ? "max-h-[800px]" : "max-h-[67px]"} rounded-[8px] bg-[#FFFFFF] text-[#35363B] p-[24px] overflow-hidden transition-[max-height] duration-500 mb-[24px] drop-shadow-[6px_6px_18px_rgba(0,108,255,0.04)]`} onClick={() => setExpanded(!expanded)}>
