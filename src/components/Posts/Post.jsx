     ...
     <div className="bg-[#F5F5F5] relative w-screen -left-[calc(50vw-50%)] pt-[80px] pb-[140px]">
      <div className="font-Montserrat max-w-[1490px] mx-auto px-[34px] text-[10px] sm:text-[14px] mb-[80px] text-[#3973C5]">
          ...
          <div className="container sm:mx-auto pt-[17px] max-w-[800px] mb-[92px]">
            <div className="text-[40px] leading-[45px] font-bold mb-[24px] text-[#35363B]">{title}</div>
            ...
            <iframe className="inline-block" title="facebook" src={`https://www.facebook.com/plugins/share_button.php?href=https://altexmn--altexnew-xgp4u0st.web.app/og/posts/${postId}/&layout=button_count&size=large&mobile_iframe=false&width=83&height=28&appId`} width="100" height="28"  scrolling="no" frameborder="0" allowTransparency="true"></iframe> 
            </div>
            <TwitterShareButton
              ...
              >
            <div className="inline-block ml-2 rounded bg-[#0075FF] text-white text-[14px] font-bold py-[12px] pl-[18px] pr-[20px] cursor-pointer">
              <svg className="inline-block mr-[23px]" width="26" height="28" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
