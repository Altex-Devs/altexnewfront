     ...
     <div className="bg-[#F5F5F5] relative w-screen -left-[calc(50vw-50%)] pt-[80px] pb-[140px]">
      <div className="font-Montserrat max-w-[1490px] mx-auto px-[34px] text-[10px] sm:text-[14px] mb-[80px] text-[#3973C5]">
          ...
          <div className="container sm:mx-auto pt-[17px] max-w-[800px] mb-[92px]">
            ...
            <iframe className="inline-block" title="facebook" src={`https://www.facebook.com/plugins/share_button.php?href=${window.location.href}&layout=button_count&size=large&mobile_iframe=false&width=83&height=28&appId`} width="100" height="28"  scrolling="no" frameborder="0" allowTransparency="true"></iframe> 
            </div>
            <TwitterShareButton
