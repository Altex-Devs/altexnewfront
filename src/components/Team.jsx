function Team() {
  return (
    <>
      <div className="flex flex-col md:flex-row gap-[24px] pb-[160px] mt-[160px] items-center border-b-[0.5px] border-b-[#13A9FD] leading-[35px] bg-gradient-radial-bottom from-[rgba(0,108,255,0.26)] to-[rgba(19,169,253,0)]">
      ...
      <div className="flex flex-col lg:flex-row gap-[24px] pb-[160px] mt-[160px] items-center border-b-[0.5px] border-b-[#13A9FD] leading-[35px]">
        <div className="grow font-extralight">
          ...
          <div className="text-[16px]">
            Манай бирж нь технологи, бүтээгдэхүүн хөгжүүлэлт, хэрэглэгчийн үйлчилгээ зэргээр мэргэшсэн, харилцагч төвтэй хамт олонтой. Мөн бид <b>Google, Apple, McKinsey</b> зэрэг дэлхийд тэргүүлэгч технологи, санхүүгийн компаниудын мэдлэг туршлагатай зөвлөхүүдтэй хамтран ажилладаг.
          </div>
        </div>
        <img src="/images/team.png" alt="team" className="w-[800px]" />
      </div>

      <div className="flex flex-col sm:flex-row gap-[85px] mt-[160px] pb-[240px] items-center top-[-500px] bg-gradient-radial-bottom from-[rgba(0,108,255,0.26)] to-[rgba(19,169,253,0)]">
        <svg className="max-w-[180px]" viewBox="0 0 190 353" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grow font-extralight">
          ...
          <p className="mb-[25px]">Азийн тэргүүлэгч финтек, дижитал хөрөнгийн компани болох <a href="#_" className="text-[#3973C5] text-[16px] underline">BC Технологийн Групп</a> (хувьцааны код: HK 863)-н охин компани болох <a href="#_" className="text-[#3973C5]">OSL</a> нь Азид дижитал хөрөнгө арилжааны тусгай лицензтэй дижитал хөрөнгийн платформ юм.</p>
          <p className="mb-[25px]"><a href="#_" className="text-[#3973C5] text-[16px] underline">OSL</a> нь дэлхийн анхны бөгөөд цорын ганц даатгалтай, SFC лицензтэй дижитал хөрөнгийн платформ бөгөөд байгууллагын үйлчлүүлэгчид болон мэргэжлийн хөрөнгө оруулагчдад брокер, кастодиан, дижитал хөрөнгийн бирж, SaaS үйлчилгээг үзүүлдэг.</p>
          <p className="mb-[25px]">Тус компани нь арилжаа эрхлэгчдэд дэлхийн хамгийн том хөрвөх чадварын санд нэвтрэх боломжийг олгодог бөгөөд OTC, iRFQ болон цахим арилжааны үйлчилгээг санал болгодог.</p>
          <p className="mb-[25px]"><a href="#_" className="text-[#3973C5] text-[16px] underline">BC Технологийн Групп</a> болон <a href="#_" className="text-[#3973C5] text-[16px] underline">OSL</a> платформ нь дижитал хөрөнгө арилжааны платформд институцийн ангилалыг нэвтрүүлж, гүйцэтгэл, аюулгүй байдлаар дэлхийн стандартыг тогтоож байна.</p>
          <p className="mb-[25px]">Дэлгэрэнгүй мэдээллийг: <a href="#_" className="text-[#3973C5] text-[16px] underline">bc.group</a> and <a href="#_" className="text-[#3973C5] text-[16px] underline">osl.com</a></p>
        </div>
      </div>
    </>
  );
