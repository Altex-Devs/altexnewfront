function Team() {
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-[85px] mt-[160px] pb-[240px] items-center">
        ...
        <div className="grow font-extralight">
          ...
          <p className="mb-[25px]">Азийн тэргүүлэгч финтек, дижитал хөрөнгийн компани болох <a href="#_" className="text-[#3973C5]">BC Технологийн Групп</a> (хувьцааны код: HK 863)-н охин компани болох <a href="#_" className="text-[#3973C5]">OSL</a> нь Азид дижитал хөрөнгө арилжааны тусгай лицензтэй дижитал хөрөнгийн платформ юм.</p>
          <p className="mb-[25px]"><a href="#_" className="text-[#3973C5]">OSL</a> нь дэлхийн анхны бөгөөд цорын ганц даатгалтай, SFC лицензтэй дижитал хөрөнгийн платформ бөгөөд байгууллагын үйлчлүүлэгчид болон мэргэжлийн хөрөнгө оруулагчдад брокер, кастодиан, дижитал хөрөнгийн бирж, SaaS үйлчилгээг үзүүлдэг.</p>
          ...
          <p className="mb-[25px]"><a href="#_" className="text-[#3973C5]">BC Технологийн Групп</a> болон <a href="#_" className="text-[#3973C5]">OSL</a> платформ нь дижитал хөрөнгө арилжааны платформд институцийн ангилалыг нэвтрүүлж, гүйцэтгэл, аюулгүй байдлаар дэлхийн стандартыг тогтоож байна.</p>
          <p className="mb-[25px]">Дэлгэрэнгүй мэдээллийг: <a href="#_" className="text-[#3973C5]">bc.group</a> and <a href="#_" className="text-[#3973C5]">osl.com</a></p>
        </div>
      </div>
    </>
  );
