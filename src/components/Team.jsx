    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-[85px] mt-[160px] pb-[240px] items-center top-[-500px] ]">
        ...
        <div className="grow font-extralight z-10">
          ...
          <div className="mb-[25px]">Азийн тэргүүлэгч финтек, дижитал хөрөнгийн компани болох <a href="https://bc.group" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">BC Технологийн Групп</a> (хувьцааны код: HK 863)-н охин компани болох <a href="https://bc.group" className="text-[#3973C5] border-b-[0.1px] border-[#3973C5]">OSL</a> нь Азид дижитал хөрөнгө арилжааны тусгай лицензтэй дижитал хөрөнгийн платформ юм.</div>
          <div className="mb-[25px]"><a href="https://osl.com" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">OSL</a> нь дэлхийн анхны бөгөөд цорын ганц даатгалтай, SFC лицензтэй дижитал хөрөнгийн платформ бөгөөд байгууллагын үйлчлүүлэгчид болон мэргэжлийн хөрөнгө оруулагчдад брокер, кастодиан, дижитал хөрөнгийн бирж, SaaS үйлчилгээг үзүүлдэг.</div>
          ...
          <div className="mb-[25px]"><a href="https://bc.group" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">BC Технологийн Групп</a> болон <a href="https://osl.com" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">OSL</a> платформ нь дижитал хөрөнгө арилжааны платформд институцийн ангилалыг нэвтрүүлж, гүйцэтгэл, аюулгүй байдлаар дэлхийн стандартыг тогтоож байна.</div>
          <div className="mb-[25px]">Дэлгэрэнгүй мэдээллийг: <a href="https://bc.group" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">bc.group</a> and <a href="https://osl.com" className="text-[#3973C5] text-[16px] border-b-[0.1px] border-[#3973C5]">osl.com</a></div>
        </div>
      </div>
    </>
  );
