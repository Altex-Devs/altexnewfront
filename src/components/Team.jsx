    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-[85px] mt-[160px] pb-[240px] items-center top-[-500px] ]">
        ...
        <div className="grow font-extralight z-10">
          ...
          <div className="mb-[25px]">Азийн тэргүүлэгч финтек, дижитал хөрөнгийн компани болох BC Технологийн Групп (хувьцааны код: HK 863)-н охин компани болох OSL нь Азид дижитал хөрөнгө арилжааны тусгай лицензтэй дижитал хөрөнгийн платформ юм.</div>
          <div className="mb-[25px]">OSL нь дэлхийн анхны бөгөөд цорын ганц даатгалтай, SFC лицензтэй дижитал хөрөнгийн платформ бөгөөд байгууллагын үйлчлүүлэгчид болон мэргэжлийн хөрөнгө оруулагчдад брокер, кастодиан, дижитал хөрөнгийн бирж, SaaS үйлчилгээг үзүүлдэг.</div>
          ...
          <div className="mb-[25px]">BC Технологийн Группболон OSL платформ нь дижитал хөрөнгө арилжааны платформд институцийн ангилалыг нэвтрүүлж, гүйцэтгэл, аюулгүй байдлаар дэлхийн стандартыг тогтоож байна.</div>
